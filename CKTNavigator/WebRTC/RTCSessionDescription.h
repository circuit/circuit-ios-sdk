...
#import "WebRTC/ANSessionDescriptionInterface.h"
#endif
...
RTC_EXPORT
#if defined(CIRCUIT_WEBRTC_CHANGES)
@interface RTCSessionDescription : NSObject <ANSessionDescriptionInterface> {
    // Garbage collected references
    JSManagedValue *_onSessionDescriptionCalback;
}
#else
