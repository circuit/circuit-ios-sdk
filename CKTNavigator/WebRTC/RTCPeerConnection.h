...
#if defined(CIRCUIT_WEBRTC_CHANGES)
#import "WebRTC/ANPeerConnectionInterface.h"
#endif
...
RTC_EXPORT
#if defined(CIRCUIT_WEBRTC_CHANGES)
@interface RTCPeerConnection : NSObject <ANPeerConnectionInterface>

/** The object that will be notifed about events such as state changes and
 *  streams being added or removed.
 */
@property(nonatomic, strong, nullable) id<RTCPeerConnectionDelegate> delegate;
#else
