...
NSString *const NOTIFICATION_VIDEO_RECEIVE_STREAM_LOST = @"circuitkit.notification.VIDEO_RECEIVE_STREAM_LOST";
...
NSString *const NOTIFICATION_AUDIO_UNIT_SETUP_FAILED = @"ansible.notification.AUDIO_UNIT_SETUP_FAILED";
// WebRTC indicates that Audio session disruption ends
NSString *const NOTIFICATION_WEBRTC_AUDIO_DISRUPTION_ENDS = @"ansible.notification.WEBRTC_AUDIO_DISRUPTION_ENDS";
...
NSString *const KEY_CALL = @"circuitkit.key.CALL";
NSString *const KEY_CALL_REPLACED = @"circuitkit.key.REPLACED_CALL_FLAG";
